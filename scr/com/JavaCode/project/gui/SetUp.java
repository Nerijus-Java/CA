...
public class SetUp {
    ...
    public void setUpLoginFrame() {
        ...
        databaseMethods = new DatabaseMethods(dataBaseConnection,catagoryCollection,paymentCollection);

        paymentCollection.setDatabaseMethods(databaseMethods);

        Login loginGUI = new Login( this, dataBaseConnection,databaseMethods);
